 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `BLModel` protocol for custom methods.
 ...
 */
@interface NSDictionary (BLModel)
...
/**
 ...
 There's no need to add '<BLModel>' to your class header.
 */
